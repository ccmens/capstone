                ...
                <div className='register-form'>
                    ...
                    >
                        ...
                        <Form.Item
                            label="Password"
                            name="password"
                            rules={[{ required: true, min: 6, message: 'Please input your password, it at least 6 characters!' }]}
                        >
                            <Input.Password />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            rules={[{ required: true, min: 6, message: 'Please input confirm password, it at least 6 characters!' }]}
                        >
                            <Input.Password />
                        </Form.Item>
